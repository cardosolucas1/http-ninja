...
const StatusList: Status[] = [
  ...
  },
  {
    code: '103',
    title: 'Early Hints',
    description: 'O código de informação de status de resposta HTTP 103 Early Hints é destinado principalmente a ser usado com o cabeçalho <em>Link</em> para permitir ao agente do usuário começar pré-carregamento de recursos enquanto o servidor ainda está preparando uma resposta.',
    image: '999.png',
  ...
  },
  {
    code: '205',
    title: 'Reset Content',
    description: 'Esta requisição é enviada após realizanda a solicitação para informar ao user agent redefinir a visualização do documento que enviou essa solicitação.',
    image: '999.png',
